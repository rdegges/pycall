...
variables--alerting Asterisk of their values. This is useful when you need to create a call
file, but also need to pass Asterisk certain information that it can use once the call is
answered. The following example creates a call file and sets several variables which give
Asterisk information about the person we are calling.
"""
